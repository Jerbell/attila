...
public class Barbarian {
	...
	// farms - both
	public static final Building LIVESTOCK_PENS = building().name("Livestock Pens").squalor(4).publicOrder(-5).foodFromAnimalHusbandry(40).foodPerFertility(10).wealthFromAnimalHusbandry(500).wealthFromAnimalHusbandryPerFertility(150).build();
	public static final Building GOAT_BARNS = building().name("Goat Barns").squalor(4).publicOrder(-5).foodFromAnimalHusbandry(70).foodPerFertility(12).wealthFromAnimalHusbandry(450).wealthFromAnimalHusbandryPerFertility(75).build();
	public static final Building IRRIGATED_FIELDS = building().name("Irrigated Fields").squalor(4).publicOrder(-5).foodFromAgriculture(40).foodPerFertility(28).wealthFromAgriculture(80).wealthFromAgriculturePerFertility(75).build();
